...
def get_lines_from_layer_output(h_org, linecolor=[1,1,1]):
    """
    -- h_org: output of a layer
    ...
    # apply relu (not any nonlinearity!) first
    h = np.array(h_org, copy=True)
    apply_nonlinearity(h)
