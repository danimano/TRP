...
W_layer2 = weight_variable([neuron_num, neuron_num], 'W2')
b_layer2 = bias_variable([neuron_num], 'b2')
...
W_layer3 = weight_variable([neuron_num, neuron_num], 'W3')
b_layer3 = bias_variable([neuron_num], 'b3')
...
W_layer4 = weight_variable([neuron_num, neuron_num], 'W4')
b_layer4 = bias_variable([neuron_num], 'b4')
...
W_layer5 = weight_variable([neuron_num, neuron_num], 'W5')
b_layer5 = bias_variable([neuron_num], 'b5')
...
W_layer6 = weight_variable([neuron_num, neuron_num], 'W6')
b_layer6 = bias_variable([neuron_num], 'b6')
...
W_layer7 = weight_variable([neuron_num, output_num], 'W7')
b_layer7 = tf.Variable(tf.constant(0.0, shape=[output_num], name='b7'))
