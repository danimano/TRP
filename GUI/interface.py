...
class MenuInterface(tk.Frame):
    ...
    def __init__(self, parent, controller, *args, **kwargs):
        ...
        self.file_menu.add_command(label = "Close file", command = lambda:self.close_file(parent), state = "disabled", accelerator = "Ctrl + W")
