...
W_layer2 = weight_variable([neuron_num, output_num], 'W2')
b_layer2 = tf.Variable(tf.constant(0.0, shape=[output_num], name='b2'))
Y = tf.identity(tf.nn.sigmoid(tf.matmul(x1, W_layer2) + b_layer2) * 255, name='y')
