...
W_layer4 = weight_variable([neuron_num, output_num], 'W4')
b_layer4 = tf.Variable(tf.constant(0.0, shape=[output_num], name='b4'))
Y = tf.identity(tf.nn.sigmoid(tf.matmul(x3, W_layer4) + b_layer4)*255, name='y')
