...
W_layer6 = weight_variable([neuron_num, output_num], 'W6')
b_layer6 = tf.Variable(tf.constant(0.0, shape=[output_num], name='b6'))
Y = tf.identity(tf.nn.sigmoid(tf.matmul(x5, W_layer6) + b_layer6)*255, name='y')
